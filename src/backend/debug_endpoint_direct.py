#!/usr/bin/env python3
"""
Script de debug para probar el endpoint directamente.
"""
...
def debug_endpoint_direct():
    """Debug del endpoint directamente"""
    print("=== DEBUG ENDPOINT DIRECT ===")
