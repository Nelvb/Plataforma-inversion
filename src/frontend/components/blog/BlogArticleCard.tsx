...
const BlogArticleCard: React.FC<BlogArticleCardProps> = ({ article, from }) => {
  ...
  return (
    <article
      className="group relative flex flex-col overflow-hidden rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl border border-gray-100 hover:border-[#6290C3]/30"
      itemScope
